...
class AsyncModbusSerialClient(ModbusBaseClient):
    ...
    def __init__(
        ...
        *,
        ...
        if framer not in [FramerType.ASCII, FramerType.RTU, FramerType.BANNER]:
            raise TypeError("Only FramerType RTU/ASCII/BANNER allowed.")
...
class ModbusSerialClient(ModbusBaseSyncClient):
    ...
    def __init__(
        ...
        *,
        ...
        if framer not in [FramerType.ASCII, FramerType.RTU, FramerType.BANNER]:
            raise TypeError("Only RTU/ASCII/BANNER allowed.")
        self.comm_params = CommParams(
            comm_type=CommType.SERIAL,
            host=port,
            baudrate=baudrate,
